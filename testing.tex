...
\section{Пошук у синтетичному сигналі}
    ...
    \subsection{Пошук шаблону без модифікацій}
        ...
        \begin{figure}[!h]
            \centering
            \subfloat[Без шуму]{%
                \includegraphics[width=0.48\textwidth]{a_1.eps}
            }
            \subfloat[Із шумом]{%
                \includegraphics[width=0.48\textwidth]{a_2.eps}
            }
...
\begin{figure}[!h]
    \centering
    \subfloat[Сигнал]{%
        \includegraphics[width=0.48\textwidth]{audio.eps}
    }
    \subfloat[Зразок]{%
        \includegraphics[width=0.48\textwidth]{audio_template.eps}
    }
...
\begin{figure}[!h]
    \centering
    \subfloat[Сигнал]{%
        \includegraphics[width=0.48\textwidth]{audio_energy.eps}
    }
    \subfloat[Зразок]{%
        \includegraphics[width=0.48\textwidth]{audio_template_energy.eps}
    }
